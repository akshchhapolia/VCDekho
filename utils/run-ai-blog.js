/**
 * Shared daily blog generator.
 * Used by api/cron/ai-blog.js and chained from api/cron/scrape.js after ai-process + digest.
 */
const db = require('./db');
const { pickTopic } = require('./blog-topics');
const {
  generateText,
  parseJsonResponse,
  stripCodeFences,
