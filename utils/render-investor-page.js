...
function renderInvestorPage(investor, related, res) {
  ...
  const html = [
    ...
    '<link rel="stylesheet" href="/css/base.css?v=83">',
    '<link rel="stylesheet" href="/css/hero.css?v=83">',
    '<link rel="stylesheet" href="/css/ambient.css?v=83">',
    '<link rel="stylesheet" href="/css/directory.css?v=83">',
