...
function renderPersonPage(person, colleagues, investor, res) {
  ...
  const html = [
    ...
    '<link rel="stylesheet" href="/css/base.css?v=95">',
    '<link rel="stylesheet" href="/css/hero.css?v=95">',
    '<link rel="stylesheet" href="/css/ambient.css?v=95">',
    '<link rel="stylesheet" href="/css/directory.css?v=95">',
